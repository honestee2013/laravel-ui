...
class BladeGenerator extends Command
{
    ...
    protected function getBladeStub($module, $modelName, $modelData, $activeTab = null) // Add $activeTab
    {
        ...
        if (isset($modelData['tab'])) {
            ...
            $tabBarLinks = "<system.views::tab-bar>\n";
            ...
            $tabBarLinks .= "</x-system.views::tab-bar>\n";
        }
        ...
        if ($includeHeader) {
            ...
            $header .= "    @include('system.views::components.layouts.navbars.auth.content-header', [ \"pageTitile\" => \"$parentPageTitle\"])\n";
            $header .= "</x-slot>\n\n";
        }
        ...
        if ($includeFooter) {
            ...
            $footer .= "    @include('system.views::components.layouts.navbars.auth.content-footer', [ ])\n";
            $footer .= "</x-slot>\n";
        }
        ...
        if ($includeSidebar) { // Conditionally include sidebar
            ...
            $sidebar .= "    <system.views::layouts.navbars.auth.sidebar moduleName=\"{{module}}\">\n";
            ////$sidebar .= "        <x-{{module}}.views::layouts.navbars.auth.sidebar-links />\n"; // Now generated by frntend js
            $sidebar .= "    </x-system.views::layouts.navbars.auth.sidebar>\n";
            $sidebar .= "</x-slot>\n\n";
        }
    ...
    protected function getTabBarLinksStub($modelData)
    {
        ...
        //foreach ($modelData['tabs'] as $tab) {
            $links .= "<system.views::layouts.navbars.sidebar-link-item\n";
