@props([
    'controls', 'columns', 'hiddenFields', 'visibleColumns', 'model', 'fieldDefinitions',
    'multiSelectFormFields', 'sortField', 'sortDirection', 'perPage',
    'moduleName', 'modelName', 'recordName', 'viewType'
])
...
<div class="row" id="{{$viewType}}">
    @if ($viewType !== 'detail')
        ...
        @if (isset($controls['files']) && $viewType == 'table')
            ...
            <div class="dropdown col-12 w-100 col-sm-auto w-sm-auto " wire:ignore>
                <a href="#" class="btn bg-gradient-primary dropdown-toggle mb-2 bt-sm pt-2  rounded-pill w-100 px-5"
                    ...
                    <span class="btn-inner--icon"><i class="fas fa-file text-sm me-1 text-white"></i></span>
                        ...
                        @if (in_array('csv', $controls['files']['export']))
                            <li class="mb-2">
                                <a wire:click="export('csv')" class="dropdown-item  border-radius-md" href="#">
                                    <span class="btn-inner--icon me-1"><i
                                            class="fas fa-file-csv me-1 text-info"></i></span>
                    ...
                    @if (in_array('print', $controls['files']))
                        ...
                        <li class="mb-2">
                            <a wire:click="printTable()" class="dropdown-item  border-radius-md" href="#">
                                <span class="btn-inner--icon me-1"><i class="fas fa-print text-sm me-1"></i></span>
                                <span class="btn-inner--text">Print</span>
                            </a>
                        </li>
                    @endif
        ...
        @if (isset($controls['filterColumns']) && $controls['filterColumns'])
            ...
            <div class="dropdown col-12 w-100 col-sm-auto w-sm-auto" >
                <a href="#" class="btn bg-gradient-primary dropdown-toggle bt-sm pt-2 me-2 w-100"
                    ...
                    <span class="btn-inner--icon"><i class="fas fa-filter text-sm me-1 text-white"></i></span>
        ...
        <!-- Show / Hide Columns -->
        @if (isset($controls['showHideColumns']) && $controls['showHideColumns'] && $viewType == 'table')

            <div class="dropdown col-12 w-100 col-sm-auto w-sm-auto">
                <a href="#" class="btn bg-gradient-primary dropdown-toggle bt-sm pt-2 me-2 w-100"
                    data-bs-toggle="dropdown" id="navbarDropdownMenuLink2" style="border-radius: 3em; height: 3em">
                    <span class="btn-inner--icon"><i class="fas fa-list text-sm me-1 text-white"></i></span>
